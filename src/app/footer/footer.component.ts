...
import { ReplaceValuePipe } from '../shared/replace-value.pipe';
import { ActivatedRoute, Router, RouterLink, RouterLinkActive } from '@angular/router';

@Component({
  selector: 'app-footer',
  standalone: true,
  imports: [OutreachComponent, ContainerRowSectionComponent, TranslateModule, ReplaceValuePipe, RouterLink, RouterLinkActive],
